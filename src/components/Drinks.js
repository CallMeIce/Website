...
<br></br>
  ...
  <div class="card-body list-group-item-success">
    <h4 className="textAppDescriptionHeader">The Irish Eyes...$9.00</h4>
  ...
  <div class="card-body list-group-item-success">
    <h6 className="textAppDescriptionHeader">The Belfast Trash Can...$12.00</h6>
  ...
  <div class="card-body list-group-item-success">
    <h6 className="textAppDescriptionHeader">Irish Lemonade...$8.00</h6>
  ...
  <div class="card-body list-group-item-success">
    <h6 className="textAppDescriptionHeader">The Mule...$8.00</h6>
